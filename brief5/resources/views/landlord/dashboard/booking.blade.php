...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
        <h1 class="app-content-headerText">Booking</h1>
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Your Form for Deleting Booking -->
                        <form action="{{ route('landlord.booking.delete', ['id' => $booking->booking_id]) }}" method="post" class="d-inline">
                            @csrf
                            @method('DELETE')
        ...
        @endif
            ...
            @else
                <div class="col-md-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-text">No bookings available.</p>
                        </div>
                    </div>
                </div>
            @endif
